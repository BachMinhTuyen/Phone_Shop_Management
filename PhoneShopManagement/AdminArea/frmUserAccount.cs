...
namespace PhoneShopManagement
{
    public partial class frmUserAccount : Form
    {
        ...
        ////            {
        ////                int rowIndex = DataGV.Rows.Add();
        ////                DataGV.Rows[rowIndex].Cells[1].Value = row[0];
        ////                DataGV.Rows[rowIndex].Cells[2].Value = row[1];
        ////                DataGV.Rows[rowIndex].Cells[3].Value = row[2];
        ////                DataGV.Rows[rowIndex].Cells[0].Value = ++CoutAccount;
        ...
        ////    txtBox_UserName.Text = DataGV.Rows[i].Cells[1].Value.ToString();
        ////    txtBox_Password.Text = DataGV.Rows[i].Cells[2].Value.ToString();
        ////    string text = DataGV.Rows[i].Cells[3].Value.ToString();// Lấy vai trò ra đem đi so sánh
